  ...
  <div class="container py-4">
          ...
          <table class="table">
            ...
            <tbody>
              ...
              <tr v-for="metrage in metragesEnAttente" :key="'m-' + metrage.id">
                <td><span class="badge bg-secondary">?? M�trage</span></td>
    ...
    <div class="card mb-4">
            ...
            <div class="row">
              ...
              <div class="col-md-4">
                <select v-model="filtreStatut" class="form-select form-select-sm">
                  ...
                  <option value="emise">�mise</option>
      ...
      <div class="card-body">
        <div v-if="facturesFiltrees.length === 0" class="text-center text-muted py-4">
          {{ factures.length === 0 ? 'Aucune facture r�cente' : 'Aucune facture correspondant aux filtres' }}
        </div>
      ...
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5>D�tail Resoconto - {{ getChantierName(detailResoconto.chantier_id) }}</h5>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <p><strong>P�riode:</strong> {{ detailResoconto.periode_month }}</p>
            ...
            <div class="row mt-3" v-if="detailResoconto.regies && detailResoconto.regies.length > 0">
              <div class="col-md-12">
                <h6>R�gies (Heures suppl�mentaires)</h6>
                      ...
                      <div class="col-md-8">
                            ...
                            <tbody>
                              <tr v-for="(percentage, zone) in detailResoconto.avancementi" :key="zone">
                                <td colspan="3">
                                  ...
                                  <div class="row">
                                    <div class="col-md-6">
                                      <small class="text-muted">1. Valeur r�elle des quantit�s pos�es:</small><br>
                                      <strong class="text-success">{{ getValoreRealeZona(zone).toFixed(2) }} CHF</strong>
                                    </div>
                                    <div class="col-md-6">
                                      <label class="form-label small"><strong>Acompte d�j� vers� (CHF HT):</strong></label>
                                      <input 
                                  ...
                                  <div class="row mt-2" v-if="accontiPerZona[zone] > 0">
                                    <div class="col-md-12">
                                      <small class="text-muted">2. Acompte � soustraire:</small><br>
                        ...
                        <div v-if="detailResoconto.regies && detailResoconto.regies.length > 0">
                          ...
                          <table class="table table-sm table-bordered">
                            ...
                            <tfoot class="table-warning">
                              <tr>
                                <td colspan="2"><strong>Sous-total R�gies:</strong></td>
                      ...
                      <div class="col-md-4">
                        ...
                        <div class="mt-3 text-center">
                          <small class="text-muted">
                            ?? Ceci est l'aper�u de la facture qui sera g�n�r�e
                          </small>
                        </div>
                      </div>
                    </div>
          ...
          <div class="modal-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <p><strong>Montant Estim�:</strong> {{ formatCurrency(calculateMontantEstimeDettagliato()) }}</p>
              </div>
            </div>
            <div class="mt-3">
              <div class="mb-3">
              ...
              <div class="mb-3">
                <label class="form-label">Acconti gi� fatturati (CHF TTC):</label>
                <input 
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="mb-3">
              ...
              <small class="text-info">Debug: {{ paiements.length }} modalit�s charg�es</small>
              <small class="text-muted">La date d'�ch�ance sera recalcul�e automatiquement</small>
            </div>
            <div class="mb-3">
              <label>Notes:</label>
    ...
    <div v-if="showAnteprimaFacture" class="modal d-block" style="background: rgba(0,0,0,0.5)">
      <div class="modal-dialog modal-lg">
        <div class="modal-content">
          <div class="modal-header">
            <h5>?? Aper�u Facture {{ factureAnteprima.numero }}</h5>
          ...
          <div class="modal-body">
            <div class="row">
              <div class="col-md-6">
                ...
                <p><strong>�ch�ance:</strong> {{ formatDate(factureAnteprima.date_echeance) }}</p>
              ...
              <div class="col-md-6">
                ...
                <hr>
                <p class="h5"><strong>{{ (factureAnteprima.acconti_precedenti || 0) > 0 ? 'Solde � payer:' : 'Total TTC:' }}</strong> 
                  <span class="text-success">{{ formatCurrency(calculateTotalFacture(factureAnteprima)) }}</span>
                </p>
              </div>
            </div>
            
            <!-- CONTENU D�TAILL� FACTURE -->
            <div class="mt-4">
              ...
              <div v-else-if="factureAnteprima.type === 'manuelle'" class="card bg-light">
                ...
                <div class="card-body">
                  <div v-if="factureAnteprima.lignes?.length > 0">
                    <table class="table table-sm">
                      <thead>
                        <tr><th>Descrizione</th><th>Qt�</th><th>Prezzo</th><th>Total</th></tr>
                      </thead>
                      <tbody>
              ...
              <div v-else class="alert alert-warning">
                <strong>?? Tipo fattura non riconosciuto</strong><br>
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="alert alert-warning">
              ...
              � La facture {{ factureRiapertura.numero }} sera supprim�e<br>
              � Le rapport redeviendra modifiable pour le chef<br>
              � La nouvelle facture gardera le m�me num�ro
            </div>
            <div class="mb-3">
              <label><strong>Motif de la correction:</strong></label>
              <textarea v-model="motivoCorrezione" class="form-control" rows="3" placeholder="D�crivez le probl�me trouv� par le client..."></textarea>
            </div>
          </div>
          <div class="modal-footer">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <div class="alert alert-info">
              ...
              � La date par d�faut est aujourd'hui<br>
              � Vous pouvez choisir une date ant�rieure (ex: 30.09)<br>
              � La date ne peut pas �tre ant�rieure � la derni�re facture �mise
            </div>
            <div class="mb-3">
              ...
              >
              <small class="text-muted">La date d'�ch�ance sera automatiquement calcul�e (+30 jours)</small>
            </div>
          </div>
          <div class="modal-footer">
...
const facturesRecentes = computed(() => {
  return factures.value
    ...
    .slice(0, 50); // Mostra pi� fatture per i filtri
});
...
const loadData = async () => {
  try {
    ...
    try {
      ...
      console.log('?? Errore caricamento metrages:', err.message);
      metrages.value = [];
    }
    ...
    try {
      ...
      console.log('?? Errore caricamento resoconti:', err.message);
      resocontiPercentuali.value = [];
    }
    ...
    try {
      ...
      if (facturesError && facturesError.code === 'PGRST205') {
        console.log('?? Tabella factures non esiste ancora');
        factures.value = [];
      ...
      console.log('?? Errore caricamento factures:', err.message);
      factures.value = [];
    }
...
// Funzioni per calcolo prezzi nel modal m�trage
...
const autoriserFacturation = async (metrage) => {
  ...
  const confirmed = await new Promise((resolve) => {
    ...
    setTimeout(() => {
      if (confirm('Approuver ce m�trage et autoriser la facturation ?')) {
        resolve(true);
      } else {
        resolve(false);
      }
  ...
  try {
    ...
    if (ultimaDataFactura && new Date(dataScelta) < new Date(ultimaDataFactura)) {
      alert(`Erreur: La date ne peut pas �tre ant�rieure � la derni�re facture (${formatDate(ultimaDataFactura)})`);
      return;
    }
    ...
    // Cr�e la facture con data personalizzata
    const { error } = await supabase
      ...
      .insert([{
        ...
        notes: `Facture g�n�r�e depuis m�trage du ${formatDate(metrage.created_at)}`,
...
const calculateZoneMontant = (zone, percentage) => {
  // Se � un resoconto finale, calcola il valore delle quantit� reali
  ...
  // DEBUG: Verifica remise suppl�mentaire
  ...
  if (chantierDevis.modalita_prezzi === 'aCorps') {
    ...
    // Applica remise suppl�mentaire se presente
...
const calculateResocontoFinaleValue = (zone) => {
  ...
  // 1. MONETIZZA il resoconto: calcola valore delle quantit� reali posate
  ...
  // 3. TROVA il 40% gi� fatturato per QUESTA ZONA
  const percentualeGiaFatturata = resocontiPercentuali.value
    .filter(r => 
      r.status === 'approved' && 
      (r.chantier_id || r.chantierId) === (detailResoconto.value.chantier_id || detailResoconto.value.chantierId) &&
  ...
  // 4. CALCOLA l'importo gi� fatturato (40% di QUESTA ZONA)
  ...
  console.log(`  Gi� fatturato: ${importoGiaFatturato.toFixed(2)} CHF`);
...
const approuverResoconto = async (resoconto) => {
  ...
  const confirmed = await new Promise((resolve) => {
    ...
    // Simula dialog personalizzato
    setTimeout(() => {
      if (confirm('Approuver ce resoconto percentuel et g�n�rer la facture ?')) {
        resolve(true);
      } else {
        resolve(false);
      }
  ...
  try {
    ...
    // NON salvare acconti nel database per resoconti finali (gi� sottratti nel calcolo)
    ...
    const { error } = await supabase
      ...
      .insert([{
        ...
        notes: `Facture g�n�r�e depuis resoconto percentuel ${resoconto.periode_month || resoconto.periodeMonth}`,
        created_at: new Date().toISOString()
      }]);
...
const generarFactureResoconto = async (resoconto) => {
  ...
  const confirmed = await new Promise((resolve) => {
    ...
    // Simula dialog personalizzato
    setTimeout(() => {
      if (confirm('G�n�rer la facture pour ce resoconto approuv� ?')) {
        resolve(true);
      } else {
        resolve(false);
      }
...
const confirmerModificationFacture = async () => {
  try {
    ...
    // Controlla solo se non � la stessa fattura che stiamo modificando
    if (ultimaDataFactura && new Date(nouvelleDate.value) < new Date(ultimaDataFactura)) {
      // Verifica se la data dell'ultima fattura � diversa da quella attuale
    ...
    // Recalcola data scadenza se modalit� pagamento � cambiata
    ...
    // Aggiorna notes con modalit� di pagamento
    let notesAggiornate = nouvellesNotes.value || '';
    if (nouvelleModalitePaiement.value) {
      // Rimuovi vecchia modalit� se presente
      notesAggiornate = notesAggiornate.replace(/Modalit�:\s*[^\n]+\n?/g, '');
      // Aggiungi nuova modalit�
      notesAggiornate = (notesAggiornate.trim() + '\nModalit�: ' + nouvelleModalitePaiement.value).trim();
    }
...
const corrigerFacture = async (facture) => {
  ...
  try {
    // Trova il m�trage associato
    const metrage = metrages.value.find(m => m.id === (facture.metrage_id || facture.metrageId));
    if (!metrage) {
      alert('M�trage associ� non trouv�');
      return;
    }
    
    console.log('Debug m�trage pour correction:', metrage);
    ...
    console.log('Montant total calcul�:', montantHT);
    ...
    alert(`Facture corrig�e: ${montantTTC.toFixed(2)} CHF`);
    loadData();
  } catch (error) {
...
const supprimerFacture = async (facture) => {
  if (!confirm(`Supprimer la facture ${facture.numero} ?\n\nATTENTION: L'�l�ment associ� sera remis en attente de facturation.`)) return;
  ...
  try {
    ...
    if (facture.type === 'manuelle') {
      ...
      const drawHeader = (doc, title) => {
        ...
        // Informazioni documento con pi� spazio
        doc.setFontSize(10);
        doc.setFont('helvetica', 'normal');
        let yInfo = 65;
        
        // Prima colonna (sinistra) - pi� spaziosa
        doc.text(`Date: ${formatDate(facture.date_facture)}`, 15, yInfo);
        
        yInfo += 10;
        doc.setFont('helvetica', 'bold');
        doc.text('FACTUR� �:', 15, yInfo);
        yInfo += 6;
        doc.setFont('helvetica', 'normal');
        
        // Dati cliente pi� grandi con text wrapping
        ...
        return Math.max(yInfo, yInfoRight) + 20; // Ancora pi� spazio dopo l'header
      };
      ...
      autoTable(doc, {
        head: [['Description', 'Unit�', 'Quantit�', 'Prix unitaire', 'Total HT']],
        body: tableData,
        startY: startY,
        theme: 'striped',
        headStyles: { 
    ...
    const drawHeader = (doc, title) => {
      ...
      if (chantier) {
        ...
        doc.setFont('helvetica', 'bold');
        doc.setFontSize(10);
        doc.text('TRAVAUX G�N�RAUX', 115, yInfoRight);
        yInfoRight += 6;
      }
    ...
    // FATTURA DA RESOCONTO FINALE - COPIA ESATTA LOGICA M�TRAGES
    if (resocontoDoc && resocontoDoc.type === 'resoconto_finale') {
      // 1. PDF M�TR�ES (senza prezzi) - COPIA ESATTA
      const docMetrees = new jsPDF({ unit: 'mm', format: 'a4' });
      let yPos = drawHeader(docMetrees, `M�TR�ES D�TAILL�ES - ${facture.numero}`);
      ...
      docMetrees.text('?? RAPPORT FINAL DE ZONE - QUANTIT�S R�ELLES POS�ES', 15, yPos + 2);
      yPos += 12;
      ...
      if (resocontoDoc?.prodotti_reali) {
        ...
        Object.entries(itemsByZone).forEach(([zoneName, items]) => {
          ...
          const tableData = items.map(item => {
            ...
            // Aggiungi prezzi anche nel PDF m�tr�es
            const prodottoDevis = chantierDevis?.produits?.find(p => p.article === item.article);
            const prezzoUnit = Number(prodottoDevis?.prix || 50);
          ...
          // Sous-total zona nel PDF m�tr�es
        ...
        // D�tail des suppl�ments par zone - COPIA ESATTA
        yPos += 10;
        docMetrees.setFontSize(14);
        docMetrees.setFont('helvetica', 'bold');
        docMetrees.text('D�TAIL DES SUPPL�MENTS PAR ZONE', 10, yPos);
        yPos += 10;
      ...
      // R�gies nel PDF m�tr�es (per technicien)
      if (resocontoDoc.regies?.length > 0) {
        // Verifica spazio per sezione r�gies
        if (yPos > 220) {
          docMetrees.addPage();
          yPos = 20;
        }
        ...
        docMetrees.setFontSize(14);
        docMetrees.setFont('helvetica', 'bold');
        docMetrees.text('R�GIES (HEURES SUPPL�MENTAIRES)', 10, yPos);
        yPos += 10;
        ...
        // Sous-total r�gies nel PDF m�tr�es
        docMetrees.setFillColor(250, 250, 250);
        docMetrees.rect(130, yPos - 2, 70, 6, 'F');
        docMetrees.setFont('helvetica', 'bold');
        docMetrees.setFontSize(9);
        docMetrees.text(`Sous-total R�gies: ${totalRegiesMetrees.toFixed(2)} CHF`, 135, yPos + 2);
        yPos += 15;
        
        // Total g�n�ral nel PDF m�tr�es
      ...
      docFacture.text('RAPPORT FINAL DE ZONE - DECOMPTE FINAL', 15, yPos + 2);
      yPos += 12;
      ...
      if (resocontoDoc?.prodotti_reali) {
        ...
        Object.entries(itemsByZone).forEach(([zoneName, items]) => {
          // Verifica spazio disponibile per zona (aumenta soglia)
          if (yPos > 220) {
            docFacture.addPage();
            yPos = 20;
          }
          ...
          // Calcola gi� fatturato zona (usa accontiPerZona gi� calcolato)
          ...
          docFacture.text(`A facturer:`, 135, yPos + 14);
      ...
      if (resocontoDoc.regies?.length > 0) {
        ...
        docFacture.setFont('helvetica', 'bold');
        docFacture.text('R�GIES', 10, yPos);
      ...
      let accontiFinali = 0;`n      if (resocontoDoc.type === 'resoconto_finale') {`n        Object.keys(resocontoDoc.avancementi || {}).forEach(zona => {`n          accontiFinali += Number(accontiPerZona.value[zona] || 0);`n        });`n      }
    ...
    docFacture.setFont('helvetica', 'bold');
    docFacture.setFontSize(12);
    const labelFinal = accontiHT > 0 ? 'SOLDE � PAYER:' : 'TOTAL TTC:';
    ...
    // Estrai modalit� di pagamento dalle notes
    const modalitaMatch = facture.notes?.match(/Conditions:\s*([^\n]+)/);
    const modalitaPagamento = modalitaMatch ? modalitaMatch[1].trim() : '30 jours net';
    ...
    // Footer rimosso - dati gi� nell'header
...
const calculateZoneMontantAnteprima = (zone, percentage, chantierId) => {
  ...
  // Per devis � corps, usa il montant forfaitaire diviso per le zone
  if (chantierDevis.modalita_prezzi === 'aCorps') {
    const montantCorps = Number(chantierDevis.montant_corps || 0);
    const numeroZone = chantierDevis.zones?.length || 1;
    let montantPerZona = montantCorps / numeroZone;
  ...
  // Per devis d�taill�, usa i prodotti
  if (!chantierDevis.produits) return 0;
...
const getUltimaDataFactura = async () => {
  try {
    ...
    console.error('Erreur r�cup�ration derni�re date facture:', error);
    return null;
  }
};
...
const confermaRiapertura = async () => {
  if (!motivoCorrezione.value.trim()) {
    alert('Veuillez ins�rer le motif de la correction');
    return;
  }
  ...
  try {
    ...
    alert(`Rapport rouvert pour correction.\nLe chef pourra le modifier et la nouvelle facture gardera le num�ro ${numeroFactureOriginale}`);
